...
class JoinRoomConfirmDialog extends ConsumerStatefulWidget {
  const JoinRoomConfirmDialog({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      JoinRoomConfirmDialogState();
}

class JoinRoomConfirmDialogState extends ConsumerState<JoinRoomConfirmDialog> {
  @override
